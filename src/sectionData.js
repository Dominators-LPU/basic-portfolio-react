...
let sectionData = [
...

     {
        ...
        Beyond practical work, I've enriched the tech community by teaching over 10,000 students, imparting knowledge and nurturing future talent. My strong foundation in Data Structures and Algorithms aids in effective problem-solving and crafting efficient solutions. Adept at working with agile methodologies, version control systems, and test-driven development, I have consistently delivered high-quality software while meeting strict deadlines.
        
        This blend of experience, technical skills, leadership, and teaching represents a unique combination, making me well-equipped to tackle complex challenges and drive innovation in any tech-driven role.`
     },

     {
        id: 3,
        title: "Projects",
        description: `As a seasoned Full Stack Developer, I have an expansive portfolio of diverse projects spanning various sectors. I've been instrumental in developing a number of successful e-commerce applications, employing technologies like MERN Stack, Python Django, and Ruby on Rails to deliver seamless, user-friendly experiences.

        At Microsoft, I made significant contributions to the evolution of Microsoft Teams, enhancing its functionality and user experience, and hence, facilitating efficient remote collaboration for millions of users globally. This project required deep proficiency in a range of programming languages and a keen understanding of the needs of a diverse user base.
        
        Additionally, I developed an innovative software solution as an alternative to Google Meets, demonstrating my ability to craft comparable tech products from scratch while adhering to top industry standards. This project exhibited my skills in ideation, design, and full-cycle development, as well as my understanding of the intricacies of video conferencing software.
        ...
        Overall, my project experiences demonstrate a solid mix of technical prowess, creativity, leadership, and a strong drive to deliver high-quality software solutions.`
     }
